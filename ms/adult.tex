...
\begin{figure}[ht]
	...
	\caption*{\footnotesize \emph{Notes:} 
		...
		Adult sites are categorized by YouGov (see \textbf{subsection xx} discussion).
...
\begin{figure}
	...
	\caption*{\footnotesize \emph{Notes:} 
		...
		The Others bar indicates traffic to all other adult sites outside of the top 10.
