...
\fancypagestyle{firstpage}{
  ...
  \lhead{\color{gray} \footnotesize Journal of Quantitative Description: Digital Media 1(2024), 1–67}
\rhead{\color{gray} \footnotesize 10.51685/jqd.2024.011}
}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LO]{\color{gray} \footnotesize Journal of Quantitative Description: Digital Media 4(2024)}
...
\author{\normalsize Lucas Shen\\ \normalsize Singapore Institute for Clinical Sciences, Singapore
...
\begin{abstract}
  ...
  \noindent\keywords{\textit{measurement, YouGov, pornography, partisanship, quantile regression, online consumption} \vspace{8ex}}  
\end{abstract}
...
To help contextualize the above figures, we present statistics on time spent consuming content from the top ten non-adult categories by traffic in \cref{tab:top10cat_description}. For each of these ten categories, we summarize statistics on hours spent in total. The median individual consumes less than 0.7 hours in seven of these categories. The three categories in which the median individual consumes more than 0.7 hours are: Business, Search Engines and Portals, and Shopping. At the 95th percentile, only three of the top ten non-adult categories have more than 20 hours spent: Chat and Instant Messaging, Business/Social Networking, and Entertainment/Streaming Media.

%In comparison, the median pornography consumer spends 0.7 hours on pornography (\cref{tab:distribution_duration}).
...
\begin{figure}[ht]
	...
	\caption*{\footnotesize \emph{Notes:} 
		The table shows the top 25 pornographic sites visited by respondents in the sample period. Pornography sites are categorized by YouGov (see the \nameref{sec:data} section).
    	The \emph{Hours} column is the total number of hours spent by all the respondents in the sample period.
    	The \emph{Visits} column is the total number of visits by all the respondents in the sample period.
...
\begin{landscape}% Landscape page
	...
	\begin{adjustbox}{max width=1.28\textwidth}
            ...
            \midrule
            \input{../tabs/top10cat_description}\\       
            \bottomrule
        \end{tabular}
        \end{adjustbox}
        \caption*{\scriptsize
        ...
        Panel A is constructed using the browsing level data (n = 6.3m web browsing records.) 
        Panel B presents summary statistics at the individual-category level.
        }
    \end{table}
\end{landscape}
...
\caption*{\footnotesize \emph{Notes:}
Lowess for time spent on online pornography (as defined in \nameref{subsec:measuring_porn_content}) vs. time spent on other non-adult leisure (``entertainment'' and ``shopping'') with a bandwidth of .3.
...
%==============================================================================
\begin{table}[ht] \centering \normalsize \setlength\tabcolsep{7 pt}
	\caption{Median Differences in Pornography Consumption}
	\label{tab:characteristics_split_by_party_medians}
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{@{\hspace{0\tabcolsep}}llrcccr@{\hspace{0\tabcolsep}}}
			\toprule
			&\multicolumn{5}{c}{\underline{Measures of pornography consumption}}\\
			&\multicolumn{1}{l}{(1)}&\multicolumn{1}{c}{(2)}&\multicolumn{1}{c}{(3)}&\multicolumn{1}{c}{(4)}&\multicolumn{1}{c}{(5)}\\			
			&\multicolumn{1}{c}{NA}&\multicolumn{1}{c}{Total}&\multicolumn{1}{c}{Democrats}&\multicolumn{1}{c}{Republicans}&\multicolumn{1}{c}{P-val}\\
			\cmidrule{2-6}
	...
	\caption*{\footnotesize \emph{Notes:}
		...
		Column (1) indicates the count of missing variables, if any.
		Columns (2)--(4) show the medians, the first quartiles, and the third quartiles for the full sample, Democrats, and Republicans.
		1st and 3rd quartiles in brackets.
		Column (5) reports p-values for the difference between Democrats and Republicans.
		See Panel A of \cref{tab:characteristics_split_by_party} for mean differences.
	}
\end{table}
...
\begin{table}[!ht] \centering \ssmall \setlength\tabcolsep{9 pt}
	...
	\caption*{\scriptsize \emph{Notes:}
		...
		This table focuses on differences in medians.
		Party identification is based on a 7-point scale. We code 1--3 as ``Democrat'', 4 as ``Independent'', 5--7 as ``Republican''.
            Column (1) indicate subgroups.
		Column (2) indicates the count of missing variables.
		Columns (3)--(5) show the mean (standard deviation) for the overall sample, Democrats, and Republicans, respectively.
		Column (6) and column (7) report the p-values and Standardized Median Differences (SMD) for Democrats vs Republicans.
		See \cref{tab:characteristics_split_by_party_medians} for median differences in pornography consumption.
	}
\end{table}
...
\begin{landscape}% Landscape page
	...
	\begin{adjustbox}{max width=1.28\textwidth}
            ...
            \cmidrule(l){2-21}
            \input{../tabs/regtab_quantile_reg_duration_adult.tex}\\
            \cmidrule(l){2-21}
            % ===================================================================
            % Panel B            
            &\multicolumn{20}{c}{\textbf{Panel B. Adjusted quantile estimates}}\\
            \cmidrule(l){2-21}
             \input{../tabs/regtab_quantile_reg_covariates_duration_adult.tex}\\          
            \bottomrule
        \end{tabular}
        \end{adjustbox}
        \caption*{\scriptsize
...
\begin{landscape}% Landscape page
	...
	\begin{adjustbox}{max width=1.28\textwidth}
            ...
            &\multicolumn{20}{c}{\textbf{Panel A. Unconditional quantile estimates}}\\
            \cmidrule(l){2-21}
            \input{../tabs/regtab_quantile_reg_proportion_duration_adult}\\
            \cmidrule(l){2-21}
            % ===================================================================
            % Panel B            
            &\multicolumn{20}{c}{\textbf{Panel B. Adjusted quantile estimates}}\\
            %&\multicolumn{1}{c}{OLS} &\multicolumn{1}{c}{p5}         &\multicolumn{1}{c}{p10}         &\multicolumn{1}{c}{p15}         &\multicolumn{1}{c}{p20}         &\multicolumn{1}{c}{p25}         &\multicolumn{1}{c}{p30}         &\multicolumn{1}{c}{p35}         &\multicolumn{1}{c}{p40}         &\multicolumn{1}{c}{p45}         &\multicolumn{1}{c}{p50}&\multicolumn{1}{c}{p55}         &\multicolumn{1}{c}{p60}         &\multicolumn{1}{c}{p65}         &\multicolumn{1}{c}{p70}         &\multicolumn{1}{c}{p75}         &\multicolumn{1}{c}{p80}         &\multicolumn{1}{c}{p85}         &\multicolumn{1}{c}{p90}         &\multicolumn{1}{c}{p95}           \\
            \cmidrule(l){2-21}
             \input{../tabs/regtab_quantile_reg_covariates_proportion_duration_adult}\\          
            \bottomrule
        \end{tabular}
        \end{adjustbox}
        \caption*{\scriptsize
...
\begin{table}[ht] \centering \small \setlength\tabcolsep{10 pt}
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{cr}
			...
			\multicolumn{1}{c}{\textbf{Percentile}}&\multicolumn{1}{c}{\textbf{\% time}}\\
			\midrule
			\input{../tabs/mar/percentiles_proportion_duration_adultsites_by_individuals.tex}\\
			\bottomrule
		\end{tabular}
	\end{adjustbox}
	\caption*{\footnotesize \emph{Notes:} The table shows key percentiles (each of the ten deciles plus quantiles at the right tail) and their corresponding values for the percentage of time on pornography sites spent by individuals who consumed pornography in the sample period. The base number is the individual's own total time spent on the web. See \cref{tab:distribution_duration} for the distribution of total time spent on pornographic websites.
...
\begin{table}[ht] \centering \small \setlength\tabcolsep{10 pt}
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{crr}
			...
			\multicolumn{1}{l}{\textbf{Percentile}}&\multicolumn{1}{c}{\textbf{Republicans}}&\multicolumn{1}{c}{\textbf{Democrats}}\\
			\midrule
			\input{../tabs/mar/percentiles_proportion_duration_adultsites_by_individuals_by_party.tex}\\
			\bottomrule
		\end{tabular}
	\end{adjustbox}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{table}[ht] \centering \small \setlength\tabcolsep{10 pt}
	...
	\begin{adjustbox}{max width=\textwidth}
		...
		%percentiles_duration_adultsites_by_individuals_by_party
            \input{../tabs/percentiles_visits_adultsites_by_individuals_by_party}\\
			\bottomrule
		\end{tabular}
	\end{adjustbox}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{table}[ht] \centering \small \setlength\tabcolsep{10 pt}
	...
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{crr}
			...
			\midrule
		%percentiles_duration_adultsites_by_individuals_by_party
            \input{../tabs/percentiles_proportion_visits_adultsites_by_individuals_by_party}\\
			\bottomrule
		\end{tabular}
	\end{adjustbox}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{landscape}% Landscape page
	...
	\begin{adjustbox}{max width=1.28\textwidth}
            ...
            &\multicolumn{20}{c}{\textbf{Panel A. Unconditional quantile estimates}}\\
            \cmidrule(l){2-21}
            \input{../tabs/regtab_quantile_reg_visits_adult}\\
            \cmidrule(l){2-21}
            % ===================================================================
            % Panel B            
            &\multicolumn{20}{c}{\textbf{Panel B. Adjusted quantile estimates}}\\
            \cmidrule(l){2-21}
             \input{../tabs/regtab_quantile_reg_covariates_visits_adult}\\          
            \bottomrule
        \end{tabular}
        \end{adjustbox}
        \caption*{\scriptsize
...
\begin{landscape}% Landscape page
	...
	\begin{adjustbox}{max width=1.28\textwidth}
            ...
            &\multicolumn{20}{c}{\textbf{Panel A. Unconditional quantile estimates}}\\
            \cmidrule(l){2-21}
            \input{../tabs/regtab_quantile_reg_proportion_visits_adult}\\
            \cmidrule(l){2-21}
            % ===================================================================
            % Panel B            
            &\multicolumn{20}{c}{\textbf{Panel B. Adjusted quantile estimates}}\\
            \cmidrule(l){2-21}
             \input{../tabs/regtab_quantile_reg_covariates_proportion_visits_adult}\\          
            \bottomrule
        \end{tabular}
        \end{adjustbox}
        \caption*{\scriptsize
...
\begin{adjustbox}{max width=\textwidth}
        ...
        \cmidrule(l){2-7}
        \input{../tabs/regtab_wls_visit_timing_4hrbins}\\
        \cmidrule(l){2-7}
        &\multicolumn{6}{c}{\textbf{Panel B. Adjusted WLS estimates}}\\
        &\multicolumn{6}{c}{Outcome variable is a binary variable based on time-of-day visit:}\\
        &\multicolumn{1}{c}{4am--8am}&\multicolumn{1}{c}{8am--12pm}&\multicolumn{1}{c}{12pm--4pm}&\multicolumn{1}{c}{4pm--8pm}&\multicolumn{1}{c}{8pm--12am}&\multicolumn{1}{c}{12am--4am}\\
        \cmidrule(l){2-7}
        \input{../tabs/regtab_wls_visit_timing_4hrbins_adjusted}\\
    \bottomrule
    \end{tabular}
    \end{adjustbox}
    \caption*{\scriptsize
