...
\caption*{\footnotesize \emph{Notes:} 
    Each panel shows the average number of hours spent consuming respective kind of content during the observation period per decile.
...
\begin{figure}[t]
	...
	\caption*{\footnotesize \emph{Notes:} 
	The dependent variable is the percentage of time individuals in our sample spent on pornographic sites. Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis. Figure shows 19 quantile estimates (5th--95th percentile in steps of 5).
		95\% confidence intervals constructed from standard errors.
...
\begin{figure}[h]
	...
	\caption*{\footnotesize \emph{Notes:} 
		The table shows the top 25 non-pornographic sites visited by the sample.
...
\begin{figure}
	...
	\caption*{\footnotesize \emph{Notes:} 
            The average minutes spent on the top 10 pornographic sites vs. all other pornographic sites.
            The top 10 pornographic sites are determined by the total amount of time spent on each site by all individuals over the sample period.
