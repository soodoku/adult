...
pdfpagemode=UseNone,
citecolor={darkgray},
pdftitle={Holier Than Thou? Partisan Gaps in Pornography}
]{hyperref}
\urlstyle{same}
\usepackage{geometry}
...
\section[Supplementary Information]{\large Supplementary Information (Authors here \today)}\label{sec:sm}
%\onehalfspacing
\normalsize
