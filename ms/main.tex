...
\begin{figure}[t]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{figure}[t]
	...
	\caption{Quantile Estimates--Partisan Differences in the Percentage of Time Spent on Pornographic Sites}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{figure}[!ht]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (with covariates)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
...
\begin{figure}[!ht]
	...
	\caption{Quantile Estimates--Partisan Differences in the Percentage of Time Spent on Pornographic Sites (with covariates)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the percentage of time individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
...
\begin{figure}
	...
	\caption*{\footnotesize \emph{Notes:} 
            The average number of hours spent on the top 10 pornographic sites by total time spent vs. all other pornographic sites.
...
\begin{figure}[ht]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (\texttt{piedomains})}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{figure}[ht]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (with covariates, \texttt{piedomains})}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		Covariates included gender (Female/Male), race (White/Black/Hispanic/Asian/Others), education level (no HS/HS graduate/some college/college graduate), age and its quadratic, and region (NE/MW/S/W).
...
\begin{figure}[t]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (Forcepoint ThreatSeeker)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		95\% confidence intervals constructed from standard errors.
...
\begin{figure}[ht]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (with covariates, Forcepoint ThreatSeeker)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		Covariates included on the right-hand side are gender (Female/Male), race (White/Black/Hispanic/Asian/Others), education level (no HS/HS graduate/some college/college graduate), age and its quadratic, and region (NE/MW/S/W).
...
\begin{figure}[t]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (Bitdefender)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		95\% confidence intervals constructed from standard errors.
...
\begin{figure}[ht]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (with covariates, Bitdefender)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		Covariates included gender (Female/Male), race (White/Black/Hispanic/Asian/Others), education level (no HS/HS graduate/some college/college graduate), age and its quadratic, and region (NE/MW/S/W).
...
\begin{figure}[t]
	...
	\caption{Quantile Estimates--Partisan Differences in Hours Spent on Pornographic Sites (alphaMountain)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of hours individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		95\% confidence intervals constructed from standard errors.
...
\begin{figure}
	...
	\caption{Quantile Estimates--Partisan Differences in Traffic to Pornography Sites}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{figure}
	...
	\caption{Quantile Estimates--Partisan Differences in Traffic to Pornography Sites (with covariates)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the number of visits to pornographic sites by individuals in our sample.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		Covariates included on the right-hand side are gender (Female/Male), race (White/Black/Hispanic/Asian/Others), education level (no HS/HS graduate/some college/college graduate), age and its quadratic, and region (NE/MW/S/W).
...
\begin{figure}
	...
	\caption{Quantile Estimates--Partisan Differences in the Percentage of Traffic to Pornography Sites}
	\caption*{\footnotesize \emph{Notes:} 
...
\begin{figure}
	...
	\caption{Quantile Estimates--Partisan Differences in the Percentage of Traffic to Pornography Sites (with covariates)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the percentage of traffic to pornographic sites by individuals in our sample.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		Covariates included on the right-hand side are gender (Female/Male), race (White/Black/Hispanic/Asian/Others), education level (no HS/HS graduate/some college/college graduate), age and its quadratic, and region (NE/MW/S/W).
...
\begin{figure}[t]
	...
	\caption{Partisan Differences in the Percentage of Time Spent on Pornography Sites}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the percentage of time individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		95\% confidence intervals constructed from standard errors.
...
\begin{figure}[!ht]
	...
	\caption{Quantile Estimates--Partisan Differences in the Percentage of Time Spent on Pornography Sites (with covariates)}
	\caption*{\footnotesize \emph{Notes:} 
		The dependent variable is the percentage of time individuals in our sample spent on pornographic sites.
		Each point indicates the difference between Republicans and Democrats and corresponds to a quantile regression at the quantile indicated by the x-axis.
		Covariates included on the right-hand side are: gender (Female/Male), race (White/Black/Hispanic/Asian/Others), education level (no HS/HS graduate/some college/college graduate), age and its quadratic, and region (NE/MW/S/W).
