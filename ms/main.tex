...
For each of these ten categories, we summarize statistics on hours spent in total.
The median individual consumes less than 0.7 hours in seven of these categories.
The three categories in which the median individual consumes more than 0.7 hours are: ''Business'', ``Search Engines and Portals'', and ``Shopping''.
At the 95th percentile, only three of the top ten non-adult categories have more than 20 hours spent: ``Chat and Instant Messaging'', ``Business, Social Networking'', and ``Entertainment, Streaming Media''.
